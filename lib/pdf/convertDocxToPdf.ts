...
export async function convertDocxToPdf(
  ...
  form.append("File", new Blob([new Uint8Array(docx)], { type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document" }), filename);
  ...
  const fileData: string | undefined = json?.Files?.[0]?.FileData;
